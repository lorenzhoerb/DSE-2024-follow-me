<template>
    <div class="relative overflow-x-auto shadow rounded-lg">
        <table class="w-full text-sm text-left rtl:text-right text-gray-500">
            ...
            <tbody>
                <tr class="bg-white border-b hover:bg-gray-50" v-for="(vehicle, idx) in vehicles" :key="idx">
                    ...
                    <td class="px-6 py-4 text-center">
                        <span v-if="vehicle.isInFollowMeMode"
                            class="bg-green-100 text-green-800 text-sm font-medium me-2 px-2.5 py-0.5 rounded">Active</span>
                        <span v-else
                            class="bg-red-100 text-red-800 text-sm font-medium me-2 px-2.5 py-0.5 rounded">Inactive</span>
                    </td>
                    <td class="px-6 py-4">
                        some vin
                    </td>
